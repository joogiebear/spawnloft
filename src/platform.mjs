...
export const PREVIEW_LIMITS = Object.freeze({
  ...
  managedDatabases: 'Automatic database installation is not available in this preview on this platform. Connect to an existing MariaDB, MySQL, or Redis database instead.',
})
